...
@section('conteudo')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="row g-3" action="{{ route('admin.vaga.update', ['vaga' => $vaga->id]) }}" onsubmit="crudHelper.Alterar(event, this)">

                <div class="form-group col-md-12">
                    <label for="nome" class="form-label">Nome</label>
                    <input id="nome" class="form-control" type="text" name="nome" value="{{ $vaga->nome }}" maxlength="255">
                </div>

                <div class="form-group col-md-12">
                    <label for="texto" class="form-label">Texto</label>
                    <textarea id="texto" class="form-control" rows="10" name="texto">{{ $vaga->texto }}</textarea>
                </div>
