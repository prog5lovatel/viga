    ...
    <div class="sidebar-wrapper active">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="{{ route('admin.inicio') }}">
                        <img src="{{ asset('admin-template/compiled/svg/logo.svg') }}" alt="Logo" srcset="">
                    </a>
                </div>
                ...
                <div class="sidebar-toggler  x">
                    <a href="javascript:;" class="sidebar-hide d-xl-none d-block"><i class="bi bi-x bi-middle"></i></a>
                </div>
            </div>
        </div>
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item  {{ Request::routeIs('admin.inicio') ? 'active' : null }}">
                    <a href="{{ route('admin.inicio') }}" class='sidebar-link'>
                        <i class="bi bi-chevron-right"></i>
                        <span>Início</span>
                    </a>
                </li>

                <li class="sidebar-item  {{ Request::routeIs('admin.popup*') ? 'active' : null }}">
                ...
                <li class="sidebar-item  {{ Request::routeIs('admin.documento*') ? 'active' : null }}">
                    <a href="{{ route('admin.documento') }}" class='sidebar-link'>
                        <i class="bi bi-chevron-right"></i>
