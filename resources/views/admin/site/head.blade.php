    ...
    <div class="card">
        ...
        <div class="card-body">
            <ul class="nav nav-tabs mb-3">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="javascript:;">Head</a>
                </li>
                <li class="nav-item">
            ...
            <form class="row g-3" action="{{ route('admin.site.updateCodigos') }}"
                onsubmit="crudHelper.Alterar(event, this)">

                <div class="form-group col-md-12">
                    <label for="codigos_head" class="form-label">Códigos - Head</label>
                    <textarea id="codigos_head" class="form-control" name="codigos_head">{{ $site->codigos_head }}</textarea>
                </div>
...
@section('pageScripts')
    ...
    <script>
        var textarea = document.getElementById("codigos_head");
