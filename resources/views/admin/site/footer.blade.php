    ...
    <div class="card">
        ...
        <div class="card-body">
            <ul class="nav nav-tabs mb-3">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="javascript:;">Footer</a>
                </li>
            </ul>
            ...
            <form class="row g-3" action="{{ route('admin.site.updateCodigos') }}" onsubmit="crudHelper.Alterar(event, this)">
                ...
                <div class="form-group col-md-12">
                    <label for="codigos_footer" class="form-label">Códigos - Footer</label>
                    <textarea id="codigos_footer" class="form-control" name="codigos_footer" rows="5">{{ $site->codigos_footer }}</textarea>
                </div>
...
@section('pageScripts')
    ...
    <script>
        var textarea = document.getElementById("codigos_footer");
