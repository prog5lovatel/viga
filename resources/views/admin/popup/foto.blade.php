    ...
    <div class="card">
        ...
        <div class="card-body">
            <ul class="nav nav-tabs mb-3">
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('admin.popup') }}">Dados</a>
                </li>
                <li class="nav-item">
            ...
            <div>
                <img src="{{ $popup->foto }}" style="max-width: 100%; width: auto; height: auto;" />
            </div>

            <hr />

            <form class="row g-3" action="{{ route('admin.popup.updateFoto') }}"
                onsubmit="crudHelper.AlterarArquivos(event, this)">

                <x-admin.cropper.input label="Foto Principal (jpg, png) 800x600" name="foto" width="800" height="600" />
