...
@section('conteudo')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form class="row g-3" action="{{ route('admin.unidade.store') }}" onsubmit="crudHelper.Cadastrar(event, this)">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input id="email" class="form-control" type="email" name="email" value="" maxlength="255">
                </div>

                <div class="form-group col-md-6">
                    <label for="telefone" class="form-label">Telefone</label>
                    <input id="telefone" class="form-control" type="text" name="telefone" value="" maxlength="255">
                </div>
