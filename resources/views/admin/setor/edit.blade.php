...
@section('caminho')
    ...
    <li class="breadcrumb-item"><a href="{{ route('admin.setor') }}">Setor</a></li>
...
@section('conteudo')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="row g-3" action="{{ route('admin.setor.update', ['setor' => $setor->id]) }}" onsubmit="crudHelper.Alterar(event, this)">

                <div class="form-group col-md-6">
                    <label for="nome" class="form-label">Nome</label>
                    <input id="nome" class="form-control" type="text" name="nome" value="{{ $setor->nome }}" maxlength="255">
                </div>

                <div class="form-group col-md-6">
                    <label for="email" class="form-label">E-mail</label>
                    <input id="email" class="form-control" type="email" name="email" value="{{ $setor->email }}">
                </div>
