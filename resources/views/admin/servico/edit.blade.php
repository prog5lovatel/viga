    ...
    <div class="card">
        ...
        <div class="card-body">
            <ul class="nav nav-tabs mb-3">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('admin.servico.fotos', ['servico' => $servico->id]) }}">Fotos</a>
                </li>
            </ul>

            <form class="row g-3" action="{{ route('admin.servico.update', ['servico' => $servico->id]) }}" onsubmit="crudHelper.Alterar(event, this)">

                <div class="form-group col-md-6">
                    <label for="nome" class="form-label">Nome</label>
                    <input id="nome" class="form-control" type="text" name="nome" value="{{ $servico->nome }}" maxlength="255">
                </div>

                <div class="form-group col-md-12">
                    <label for="texto" class="form-label">Texto</label>
                    <textarea id="texto" class="form-control" rows="10" name="texto">{{ $servico->texto }}</textarea>
                </div>
