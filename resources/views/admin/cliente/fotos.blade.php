    ...
    <div class="card">
        ...
        <div class="card-body">
            <ul class="nav nav-tabs mb-3">
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('admin.cliente.edit', ['cliente' => $cliente->id]) }}">Dados</a>
                </li>
                <li class="nav-item">
            ...
            <div>
                <img src="{{ $cliente->foto }}" style="max-width: 100%; width: auto; height: auto;" />
            </div>

            <hr />

            <form class="row g-3" action="{{ route('admin.cliente.updateFotos', ['cliente' => $cliente->id]) }}" onsubmit="crudHelper.AlterarArquivos(event, this)">

                <x-admin.cropper.input label="Foto Principal ( jpg, png ) 310x170" name="foto" width="310" height="170" />
