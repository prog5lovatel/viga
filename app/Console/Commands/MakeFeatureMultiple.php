...
class MakeFeatureMultiple extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'make:feature-multiple {name} {--table=} {--label=}';
     ...
     * @var string
     */
    protected $description = 'Cria uma funcionalidade para o site com relacionamento';
    ...
    public function handle(): void
    {
        ...
        $this->buildModelFoto($name, $table);
        ...
        sleep(1);
        $this->buildMigrationFotos($name, $table);
        $this->buildRoutes($name, $table);
        $this->buildViews($name, $table, $label);

        $this->newLine(3);

        $this->info('php8.1 artisan migrate');
    ...
    {
        $stubPath = app_path('Console/Commands/Stubs/Multiple/make-model.stub');
    ...
    private function buildModelFoto($name, $table)
    {
        $stubPath = app_path('Console/Commands/Stubs/Multiple/make-modelfoto.stub');
        ...
        // Crie o arquivo de modelo no diretório adequado
        $modeloPath = app_path('Models/' . $name . 'Foto.php');
    ...
    {
        $stubPath = app_path('Console/Commands/Stubs/Multiple/make-controller.stub');
    ...
    {
        $stubPath = app_path('Console/Commands/Stubs/Multiple/make-fotosrequest.stub');
    ...
    {
        $stubPath = app_path('Console/Commands/Stubs/Multiple/make-storerequest.stub');
    ...
    {
        $stubPath = app_path('Console/Commands/Stubs/Multiple/make-updaterequest.stub');
    ...
    {
        $stubPath = app_path('Console/Commands/Stubs/Multiple/make-migration.stub');
    ...
    private function buildMigrationFotos($name, $table)
    {
        $stubPath = app_path('Console/Commands/Stubs/Multiple/make-migrationfotos.stub');
        ...
        // Crie o arquivo de modelo no diretório adequado
        $modeloPath = database_path('migrations/' . date('Y_m_d_His') . '_create_' . $table . '_fotos_table.php');
    ...
    private function buildRoutes($name, $table)
    {
        ...
        $stubPath = app_path('Console/Commands/Stubs/Multiple/make-routes.stub');
    ...
    {
        $stubPaths = [
            'create' => app_path('Console/Commands/Stubs/Multiple/views/make-create.stub'),
            'edit' => app_path('Console/Commands/Stubs/Multiple/views/make-edit.stub'),
            'fotos' => app_path('Console/Commands/Stubs/Multiple/views/make-fotos.stub'),
            'list' => app_path('Console/Commands/Stubs/Multiple/views/make-list.stub')
        ];
